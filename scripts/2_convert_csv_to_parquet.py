...
def create_3d_from_daily():
    """Use 3D data from 3D_raw folder (TradingView exports) instead of resampling"""
    
    print("="*60)
    print("SKIPPING 3D GENERATION - USING TRADINGVIEW 3D_RAW DATA")
    print("="*60 + "\n")
    
    # 3D is already processed in the main loop from 3D_raw folder
    # No need to resample from daily
    print("✓ 3D data already processed from 3D_raw folder")
    print("  (Make sure you have exported 3D data from TradingView to data/3D_raw/)")
    return
