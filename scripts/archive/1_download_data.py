...
def download_all_data():
    ...
    # Oanda granularity mapping (3D excluded - will be added manually)
    granularity_map = {
        "H1": "H1",
        "H4": "H4",
        "D": "D",
    ...
    # Filter out 3D from download (will be added manually from TradingView)
    timeframes_to_download = [tf for tf in TIMEFRAMES if tf not in ['3D']]
    
    # Create 3D_raw folder for manual data
    (DATA_PATH / "3D_raw").mkdir(parents=True, exist_ok=True)
    
    checkpoint = load_checkpoint()
    
    print("\n" + "="*60)
    print("DOWNLOADING ALL 28 PAIRS")
    print("Timeframes: H1, H4, D, W, M (3D folder created for manual data)")
    print("="*60 + "\n")
    ...
    print("\n" + "="*60)
    print("✓ DOWNLOAD COMPLETE - All 28 pairs saved as CSV!")
    print("="*60)
    print(f"Downloaded timeframes: H1, H4, D, W, M")
    print(f"")
    print(f"IMPORTANT: Add your 3D data manually to data/3D_raw/")
    print(f"           (Folder already created and ready)")
    print(f"")
